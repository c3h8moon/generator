...
//        answer.addAttribute(new Attribute("id", introspectedTable.getSelectByCdtStatementId())); //$NON-NLS-1$
        ...
        for (IntrospectedColumn introspectedColumn : introspectedTable.getBaseColumns()) {
            if ("delFlag".equals(introspectedColumn.getJavaProperty()))
                continue;
            if ("remarks".equals(introspectedColumn.getJavaProperty()))
                continue;
            if ("updateDate".equals(introspectedColumn.getJavaProperty()))
                continue;
            if ("updateBy".equals(introspectedColumn.getJavaProperty()))
                continue;
            if ("createDate".equals(introspectedColumn.getJavaProperty()))
                continue;
    ...
    public XmlElement addElement_getByDto(XmlElement parentElement) {
        ...
        answer.addAttribute(new Attribute("id", "getByDto")); //$NON-NLS-1$
    ...
    public XmlElement addElement_query(XmlElement parentElement) {
        ...
        answer.addAttribute(new Attribute("id", "getQueryCriteria")); //$NON-NLS-1$
        if (introspectedTable.getRules().generateResultMapWithBLOBs()) {
            answer.addAttribute(new Attribute("resultMap", //$NON-NLS-1$
                    introspectedTable.getResultMapWithBLOBsId()));
        } else {
    ...
    public XmlElement addElement_del(XmlElement parentElement) {
        ...
        answer.addAttribute(new Attribute("id", "deleteByQueryCriteria")); //$NON-NLS-1$
        //        if (introspectedTable.getRules().generateResultMapWithBLOBs()) {
        //            answer.addAttribute(new Attribute("resultMap", //$NON-NLS-1$
        //                    introspectedTable.getResultMapWithBLOBsId()));
        //        } else {
