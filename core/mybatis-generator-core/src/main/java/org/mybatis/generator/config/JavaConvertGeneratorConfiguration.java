 ...
 * @author Jeff Butler
 */
public class JavaConvertGeneratorConfiguration extends TypedPropertyHolder {
...
//    private String implementationPackage;
     ...
     *
     */
    public JavaConvertGeneratorConfiguration() {
        super();
    }
    ...
    public XmlElement toXmlElement() {
        XmlElement answer = new XmlElement("javaConvertGenerator"); //$NON-NLS-1$
