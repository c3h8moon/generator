 ...
 * @author Jeff Butler
 */
public class JavaFacadeImplTestGeneratorConfiguration extends TypedPropertyHolder {
...
//    private String implementationPackage;
     ...
     *
     */
    public JavaFacadeImplTestGeneratorConfiguration() {
        super();
    }
    ...
    public XmlElement toXmlElement() {
        XmlElement answer = new XmlElement("javaFacadeImplTestGenerator"); //$NON-NLS-1$
