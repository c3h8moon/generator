    ...
    public void addElements(XmlElement parentElement) {
        ...
        for (IntrospectedColumn introspectedColumn : introspectedTable.getAllColumns()) {
            ...
            insertNotNullElement
                    .addElement(new TextElement(Ibatis2FormattingUtilities.getEscapedColumnName(introspectedColumn)));
            ...
            valuesNotNullElement
                    .addElement(new TextElement(Ibatis2FormattingUtilities.getParameterClause(introspectedColumn)));
