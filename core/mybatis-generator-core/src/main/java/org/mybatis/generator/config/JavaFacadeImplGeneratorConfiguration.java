 ...
 * @author Jeff Butler
 */
public class JavaFacadeImplGeneratorConfiguration extends TypedPropertyHolder {
...
//    private String implementationPackage;
     ...
     *
     */
    public JavaFacadeImplGeneratorConfiguration() {
        super();
    }
    ...
    public XmlElement toXmlElement() {
        XmlElement answer = new XmlElement("javaFacadeImplGenerator"); //$NON-NLS-1$
